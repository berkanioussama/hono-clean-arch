...
- Consider performance implications. Not just functionality

## Code Quality

- Do not use old or deprecated patterns. Always check latest documentation for current methods. Monitor framework changelogs and breaking changes
